...
| Role	       | - AWS services <br>- Users<br>- Applications	| - A set of permissions <br>- Similar to a User, but not uniquely associated to a person <br>- a IAM identity with specific permissions <br> - For EC2 instants or AWS services
| - Assumed temporarily<br>- Used for granting permissions to accounts/services<br>- No long-term credentials |
